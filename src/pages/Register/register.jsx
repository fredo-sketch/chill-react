...
const bgRegister = "/images/daftar-bg.jpg";
const logoChill = "/images/Logo.svg";
const bgLogin = "/images/daftar-bg.jpg";
...
const Register = () => {
  ...
  return (
    <main style={{ backgroundImage: `url(${bgRegister})` }} className="bg-[#18181b] bg-cover bg-center bg-no-repeat min-h-screen flex items-center justify-center p-4">
      {/* CARD REGISTER */}
      ...
      <div className="bg-[#18181b]/80 backdrop-blur-md p-8 md:p-10 rounded-2xl shadow-2xl w-full max-w-105 text-center border border-zinc-800">
        ...
        {/* JUDUL */}
        <h2 className="text-white text-2xl font-bold mb-1">Daftar</h2>
        <p className="text-zinc-400 text-sm mb-6">Buat Akun Baru</p>
        ...
        <form onSubmit={handleRegister} className="space-y-4 text-left">
          ...
          <div>
            ...
            <div className="relative flex items-center">
              ...
              />
              <img
                src={showConfirmPassword ? eyeOn : eye}
                alt="Toggle Password Visibility"
                onClick={() => setShowConfirmPassword(!showConfirmPassword)}
                className="absolute right-4 top-1/2 -translate-y-1/2 cursor-pointer w-5 h-5 text-zinc-400 z-10"
              />
            </div>
          </div>
